    ...
    <div className="volunteer-app-container">
      <header className="app-header">
        ...
        <nav className="nav-links">
          ...
          <a href="#" className="nav-button">Profile</a>
          <a href="#" className="nav-button">Sign Out</a>
        </nav>
      </header>
        ...
        <div className="form-section">
          ...
          <form>
            ...
            <div className="volunteer-info">
              ...
              <p><strong>Skills:</strong> Packing</p>
              <p><strong>Preferences:</strong> Night</p>
              <p><strong>Events:</strong></p>
              <div className="input-field">
                <select id="eventChoices">
                  <option value="">Select Events</option>
                  <option value="blood-drive">Food Drive – Skills: packing, assisting</option>
                  <option value="donation">Donation – Skills: assisting</option>
                  <option value="Fundraisers">Fundraisers – Skills: assisting</option>
                </select>
              </div>
            </div>

            <button type="submit" className="btn-submit">Match</button>
          </form>
        </div>
